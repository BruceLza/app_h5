    ...
    <div class="footer">
      ...
      <div class="right_btn">
       <!-- <div class="btn1" @click="handModel(1)" v-if="detailObj.module == '实物'">加入购物车</div>-->
        <div class="btn2 buy-now" style="width:40vw" @click="handModel(2)" v-if="detailObj.module == '实物'">立即购买</div>
        <div class="btn3 buy-now" style="width:40vw" @click="handModel(2)" v-if="detailObj.module == '虚拟'">立即购买</div>
      </div>
    </div>
    <!--选择规格-->
    <div v-transfer-dom>
