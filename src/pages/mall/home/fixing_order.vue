      ...
      <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
        <div class="content">
          <div id="d9">
            <div class="content_main" v-for="(items,index) in shopList" :key="index">
              <div class="list">
                ...
                <div class="status" v-if="items.shopOrderStatus == 1 && items.orderStatus == -3">
                  <div class="btn" @click="jumpTo({name:'mallBuyNew',query:{orderSn:items.orderSn,status:'-4'}})">补交资料</div>
                </div>
                ...
                <div class="status" v-if="items.payStatus == 1&&items.orderStatus == 1">
                  <div class="btn1" @click="jumpTo({name:'mallLogistics',query:{orderSn:items.orderSn}})">查看物流</div>
            ...
            <div style="width:100%;text-align:center" v-show="shopList.length==0">
              <img style="margin-top:1rem;margin-bottom:25px;" src="../../../assets/wudingdan.png" alt="">
              <div >暂无相关订单~</div>
            </div>
          </div>
        </div>
