...
// 地址添加
export const addAdress = function (username, mobile, province, city, district, town, address, isdefault, type) {
  return http.post(mall + '/users/address-post', {username, mobile, province, city, district, town, address, isdefault, type})
}
// 地址修改
export const updateAdress = function (username, mobile, province, city, district, town, address, isdefault, type, id) {
  return http.post(mall + '/users/address-post', {username, mobile, province, city, district, town, address, isdefault, type, id})
}
// 获取乡镇列表
export const getTownsList = function (id) {
  return http.post(mall + '/address/town-by-country-id', {id})
}
// 商家中心
...
// 面膜购买
export const facialInterim = function (goodsId, goodsNum, spid) {
  return http.post(mall + '/cart/interim', {goodsId, goodsNum, spid}, true)
}
// 查询订单
...
// 创建订单
export const orderCreate = function (goodsInfo, note, deduce,usecredit ) {
  return http.post(mall + '/order/create', {goodsInfo: goodsInfo, note: note, deduce,usecredit }, true)
}
// 订单记录
...
//新积分
export const newjifenInfo = function () {
  return http.post('/amoy/user/user-credits', {}, true)
}
//兑换ceo
export const coverCeo = function () {
  return http.post('/mall/ceo/ceo-price', {}, true)
}
//兑换ceo

export const coverCeoTicket = function (use_credit) {
  return http.post('/mall/ceo/ceo-exchange', {use_credit}, true)
}
//ceo转出

export const ceoRollout = function (account,ceo_address,ceo_num) {
  return http.post('/mall/ceo/ceo-turn-out', {account,ceo_address,ceo_num}, true)
}
// 积分记录
...
//积分明细
export const ticketMsgList = function (credittype, page) {
  return http.post('amoy/user/credit-detailed', {credittype: credittype, page: page})
}
//ceo转出记录
export const ceoRolloutLog = function (type, page) {
  return http.post('/mall/ceo/ceo-charge', {type: type, page: page})
}
...
// 线上商城-- 面膜
export const underGoodsmQrcodeCon = function (goodsId) {
  return http.post(mall + '/qrcode/mgoods', {goodsId: goodsId} , true)
}
// 线下商城-- 商家页面二维码
