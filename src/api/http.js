...
if (baseApiUrl.indexOf('172.16') !== -1 || baseApiUrl.indexOf('localhost') !== -1) {
  ...
  // baseApiUrl = 'http://houniao.meida520.cn/api/' + config.bizId
  baseApiUrl = 'http://houniaosuper.meida520.cn/api/' + config.bizId
  // baseApiUrl = 'http://houniaotest.meida520.cn/api/' + config.bizId
}
