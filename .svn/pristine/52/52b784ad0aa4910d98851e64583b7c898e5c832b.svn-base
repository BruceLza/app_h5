      ...
      this.$http.post('/amoy/user/invite', {}, true, true).then(res => {
        if (res.code === 0) {
          ...
          res.data.img.forEach((item) => {
            ...
            // this.imgs.push('http://houniaotest.meida520.cn/api/131' + '/amoy/user/invite?tpl=' + item + '&uid=' + this.info.uid + '&invite_code=' + this.info.invite_code)
            this.imgs.push('http://houniaosuper.meida520.cn/api/131' + '/amoy/user/invite?tpl=' + item + '&uid=' + this.info.uid + '&invite_code=' + this.info.invite_code)
          })
          this.data = res.data
        }
      })
