    ...
    <div class="firmOrder_main">
        ...
        <div v-for="(items,index) in obj.cartList" :key="index" class="one-shop-order">
          ...
          <div class="content_main" style="margin-top:0.1rem;">
            <div class="list">
              ...
              <div>
                <textarea name="" id="" style="border:0;background:#EEEEEE;width:88vw;padding:2vw" cols="30" rows="10" placeholder="备注信息不超过50个字" v-model="items.models"></textarea>
              </div>
              <div class="li_main">
      ...
      <div class="footer">
          <div class="footer_main">
            ...
            <div class="div_btn" @click="handDetail()">立即领取</div>
          </div>
      </div>
    </div>
</template>
