  ...
  <div id="goods" ref="goods" v-if="other">
    ...
    <div id="box" ref="box">
      ...
      <div class="goodsInst">
        ...
        <div class="priceBox">
          ...
          <div class="profit"  :style="{background: 'linear-gradient('+$store.state.global.theme.deg+'deg,' +$store.state.global.theme.mainColor+','+$store.state.global.theme.secondColor+')'}">预估收益{{other.commission_money}}积分</div>
        </div>
    ...
    <div class="footer">
      ...
      <div class="collect" @click="share">
        ...
        <p>分享赚{{other.commission_money}}积分</p>
      </div>
